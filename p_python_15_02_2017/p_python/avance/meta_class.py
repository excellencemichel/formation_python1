...
#La construction d'une classe sans passer par le clé 'class'
...
#Les métaclass
#Les métaclasses permettent à une classe de prendre pour métaclasse autre que la
...
class Mc(metaclass=Metaclass):#Ce nom 'metaclass' ne  change pas
    """ Ce nom 'metaclass' passé en parametre de la classe pour monter que la
